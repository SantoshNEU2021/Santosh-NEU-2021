 ...
 */
package userinterface.RawMaterialRole;
 ...
 * @author santo
 */
public class RawMaterialWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private RawMaterialOrganization rawMaterialOrganization;
    private Enterprise enterprise;
    private Network network;
    private static Logger log = Logger.getLogger(RawMaterialWorkAreaJPanel.class);
    private static final String CLASS_NAME = RawMaterialWorkAreaJPanel.class.getName();
    public RawMaterialWorkAreaJPanel(JPanel userProcessContainer, UserAccount userAccount, RawMaterialOrganization rawMaterialOrganization, Enterprise enterprise, EcoSystem business, Network network) {
        initComponents();
        this.userProcessContainer = userProcessContainer;
        this.userAccount = userAccount;
        this.rawMaterialOrganization = rawMaterialOrganization;
    ...
    public void populateTable() {
        ...
        for (WorkRequest request : rawMaterialOrganization.getWorkQueue().getWorkRequestList()) {
            Object[] row = new Object[6];
            row[0] = ((RawMaterialWorkRequest) request);
            row[1] = ((RawMaterialWorkRequest) request).getQuantity();
            row[2] = request.getSender().getEmployee().getName();
            row[3] = request.getReceiver() == null ? null : request.getReceiver().getEmployee().getName();
            row[4] = request.getStatus();
            row[5] = ((RawMaterialWorkRequest) request).getDeliveryTime();
    ...
    private void btnProcessActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProcessActionPerformed
        ...
        RawMaterialWorkRequest request = (RawMaterialWorkRequest) tblChemical.getValueAt(selectedRow, 0);
        if (tblChemical.getValueAt(selectedRow, 4) != null) {
        ...
        RawMaterialWorkRequestJPanel processWorkRequestJPanel = new RawMaterialWorkRequestJPanel(userProcessContainer, request);
