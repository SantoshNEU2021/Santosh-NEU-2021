 ...
 * @author santo
 */
public class ExistingResultsJPanel extends javax.swing.JPanel {
    ...
    private static Logger log = Logger.getLogger(ExistingResultsJPanel.class);
    private static final String CLASS_NAME = ExistingResultsJPanel.class.getName();
    public ExistingResultsJPanel(JPanel userProcessContainer,UserAccount userAccount,Enterprise enterprise, SupplierOrganization supplierOrganization,Network network,Supplier supplier) {
        initComponents();
        ...
        populateTable();
        txtNameDrug.setText(supplier.getGPUName());
    }
    ...
    private void btnBackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBackActionPerformed
        ...
        ResultsJPanel lrjp = (ResultsJPanel) component;
        lrjp.populateTable();
