...
public class SupplierWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private static Logger log = Logger.getLogger(SupplierWorkAreaJPanel.class);
    private static final String CLASS_NAME = SupplierWorkAreaJPanel.class.getName();
    public SupplierWorkAreaJPanel(JPanel userProcessContainer, EcoSystem business, UserAccount userAccount, Organization organization, Enterprise enterprise, Network network) {
        initComponents();
        ...
        log.debug(userAccount+" "+"logged in supplier work area");
        populateTable();
    }
    ...
    public void populateTable(){
        ...
        for (WorkRequest request : supplierOrganization.getWorkQueue().getWorkRequestList()) {
            if (((SupplierWorkRequest) request).getBuild()== null) {
    ...
    private void initComponents() {
        ...
        tblWorkAreaDrug1 = new javax.swing.JTable();
        ...
        tblWorkAreaDrug1.setFont(new java.awt.Font("Microsoft JhengHei UI Light", 0, 20)); // NOI18N
        tblWorkAreaDrug1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tblWorkAreaDrug1.setRowHeight(30);
        jScrollPane3.setViewportView(tblWorkAreaDrug1);
    ...
    private void btnAddDrugActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddDrugActionPerformed
        ...
        userProcessContainer.add("AddGPUJPanel", new AddGPUJPanel(userProcessContainer, business, userAccount, supplierOrganization, enterprise, network));
    ...
    private void btnViewLabReqActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewLabReqActionPerformed
        // TODO add your handling code here:
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();   
        log.debug(userAccount+" "+"entering GPU adding page");     
        userProcessContainer.add("ResultsJPanel", new ResultsJPanel(userProcessContainer, userAccount, enterprise, supplierOrganization, network, business));
        layout.next(userProcessContainer);
    ...
    private void btnReqChemicalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReqChemicalActionPerformed
        ...
        userProcessContainer.add("ViewRawMaterialsRequestJPanel", new ViewRawMaterialsRequestJPanel(userProcessContainer, userAccount, enterprise, supplierOrganization, network));
        layout.next(userProcessContainer);
    ...
    private void btnProcessActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProcessActionPerformed
        ...
        SupplierWorkRequest request = (SupplierWorkRequest) tblWorkAreaDrug.getValueAt(selectedRow, 0);
        if (tblWorkAreaDrug.getValueAt(selectedRow, 4) == null) {
        ...
        ProcessingSupplierWorkRequestJPanel processWorkRequestJPanel = new ProcessingSupplierWorkRequestJPanel(userProcessContainer, request);
    ...
    private javax.swing.JTable tblWorkAreaDrug1;
