...
import Business.WorkQueue.RawMaterialWorkRequest;
 ...
 * @author santo
 */
public class ViewRawMaterialsRequestJPanel extends javax.swing.JPanel {
 private JPanel userProcessContainer;
    ...
    private static Logger log = Logger.getLogger(ViewRawMaterialsRequestJPanel.class);
    private static final String CLASS_NAME = ViewRawMaterialsRequestJPanel.class.getName();
    /**
     * Creates new form ViewChemicalRequestJpanel
     */
     public ViewRawMaterialsRequestJPanel(JPanel userProcessContainer,UserAccount userAccount,Enterprise enterprise,SupplierOrganization supplierOrganization,Network network) {
        initComponents();
    ...
    public void reorderTable(){
      ...
      for(RawCompound cc : supplierOrganization.getRawCompoundListList()){
    ...
    private void btnAddChemicalsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddChemicalsActionPerformed
        ...
        supplierOrganization.addRawCompound(m);
        ...
        JOptionPane.showMessageDialog(null, "Raw Material Added Successfully", "Warning", JOptionPane.INFORMATION_MESSAGE);
        txtSerialNumber.setText("");
        txtChemicalName.setText("");
        txtAvailableQuantity.setText("");
        txtRequiredQuantity.setText("");
        log.debug(userAccount+" "+"added material"+name);
    ...
    private void btnInventoryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInventoryActionPerformed
        // TODO add your handling code here:
                int i=0;
        for(RawCompound mi : supplierOrganization.getRawCompoundListList()){
            i++;
            
        }
        if(i<=0)
        {
            JOptionPane.showMessageDialog(null,"No materials are present for invetory check  ");
            return;
        }
       for(RawCompound cc : supplierOrganization.getRawCompoundListList()){
            ...
            if(cc.getAvailQuantity()<=cc.getRequiredQuantity()){
                if(!cc.getReorderStatus().equals("Y")){
                    RawMaterialWorkRequest request=new RawMaterialWorkRequest();

                    cc.setReorderStatus("Y");
                    request.setRawMaterialName(cc.getRawMaterialName());
                    ...
                    for(Enterprise enterprise :network.getEnterpriseDirectory().getEnterpriseList() ){
                        ...
                        for(Organization organization:enterprise.getOrganizationDirectory().getOrganizationList()){
                            ...
                            if(organization.getName().equalsIgnoreCase("Raw Material Organization")){
                                ...
                                log.debug("raw material request has been sent to raw material organization");
    ...
    private void btnViewRequestsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewRequestsActionPerformed
        ...
        userProcessContainer.add("ViewRequestJPanel", new ViewRequestsJpanel(userProcessContainer, userAccount, enterprise, supplierOrganization));
    ...
    private void btnViewDetailsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewDetailsActionPerformed
        ...
        RawCompound cc = (RawCompound)tblReorder.getValueAt(row, 0);
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        userProcessContainer.add("UpdateEntryJPanel", new ViewRawMaterialDetailsJpanel(userProcessContainer, userAccount, enterprise,cc));
