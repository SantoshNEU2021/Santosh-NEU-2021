...
public class ViewRequestsJpanel extends javax.swing.JPanel {
    ...
    public ViewRequestsJpanel(JPanel userProcessContainer, UserAccount userAccount, Enterprise enterprise, SupplierOrganization supplierOrganization) {
        initComponents();
    ...
    public void populateTable(){
        ...
        for (WorkRequest request : userAccount.getWorkQueue().getWorkRequestList()){
            ...
            String result = ((RawMaterialWorkRequest) request).getStatus();
            row[3] = result == null ? "Waiting" : result;
            if(((RawMaterialWorkRequest) request).getDeliveryTime()==null){
                row[4]="Details yet to be updated by supplier";
            }
            else{
            row[4]  = "Expected " +((RawMaterialWorkRequest) request).getDeliveryTime();
                    }
    ...
    private void btnBackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBackActionPerformed
        ...
        ViewRawMaterialsRequestJPanel dw = (ViewRawMaterialsRequestJPanel) component;
        dw.reorderTable();
