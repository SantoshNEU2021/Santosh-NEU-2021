...
public class ViewDetailsJPanel extends javax.swing.JPanel {
    ...
    private GPUInventoryList gpuInventoryList;
    private Organization org;
    private WholesaleOrganization wo;
    private GPUInventory gpuInventory;
    ...
    public ViewDetailsJPanel(JPanel userProcessContainer, UserAccount userAccount, Enterprise enterprise, GPUInventory gpuInventory) {
        initComponents();
        ...
        txtSerialNumber.setText(String.valueOf(gpuInventory.getSerialNumber()));
        txtInStock.setText(String.valueOf(gpuInventory.getAvailQuantity()));
        txtMedicineName.setText(gpuInventory.getGPUName());
    ...
    private void initComponents() {
        ...
        btnSave.setFont(new java.awt.Font("Palatino Linotype", 0, 14)); // NOI18N
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        {
            JOptionPane.showMessageDialog(null,"please enter a valid GPU name");
            return;
        }
        gpuInventory.setGPUName(txtMedicineName.getText());
        try{
        int availableQuantity = Integer.parseInt(txtInStock.getText());
          gpuInventory.setAvailQuantity(availableQuantity);
        }
      ...
      try
      {
        ...
        gpuInventory.setSerialNumber(serialNumber);
      }
      catch(NumberFormatException e)
      {
          JOptionPane.showMessageDialog(null, "serial number must be integer!");
        ...
        log.debug(userAccount+" "+" updated the GPU details");

        JOptionPane.showMessageDialog(null, "GPU updated Successfully", "Warning", JOptionPane.INFORMATION_MESSAGE);
