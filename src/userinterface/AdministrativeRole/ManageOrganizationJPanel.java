...
import Business.Enterprise.RawMaterialEnterprise;
import Business.Enterprise.SupplierEnterprise;
import Business.Enterprise.Enterprise;
import Business.Enterprise.TechStoreEnterprise;
import Business.Enterprise.WholesaleEnterprise;
...
public class ManageOrganizationJPanel extends javax.swing.JPanel {
    ...
    private void populateComboBox(){
        ...
        for (Organization.Type type : Organization.Type.values()){
            ...
            {
//                
                if(enterprise instanceof TechStoreEnterprise){
                    
                     cbxOrganization.addItem(Organization.Type.Builder);
                     cbxOrganization.addItem(Organization.Type.Software);
                     break;
                }
                else if(enterprise instanceof SupplierEnterprise)
                {
                     cbxOrganization.addItem(Organization.Type.Supplier);
                     break;
                }           
                   else if(enterprise instanceof RawMaterialEnterprise)
                {
                  cbxOrganization.addItem(Organization.Type.RawMaterials);
                     break;  
                }
                    else if(enterprise instanceof WholesaleEnterprise){
                    
                        cbxOrganization.addItem(Organization.Type.Wholesaler);
                    break;
    ...
    private void initComponents() {
        ...
        tblOrganization.setFont(new java.awt.Font("Palatino Linotype", 0, 11)); // NOI18N
        ...
        cbxOrganization.setFont(new java.awt.Font("Palatino Linotype", 0, 11)); // NOI18N
        cbxOrganization.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        cbxOrganization.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        ...
        btnAddOrg.setFont(new java.awt.Font("Palatino Linotype", 0, 14)); // NOI18N
